...
## <a name="making-your-next-change"></a>Внесение следующего изменения

Нужно внести дополнительные изменения по другой теме? Вернитесь к главной ветви, извлеките данные из вышестоящего репозитория, чтобы удостовериться в актуальности вилки, и проверьте новую ветвь.  Выполните следующие команды в Git Bash:
