...
1. Содержимое на некоторых страницах документов можно редактировать прямо в браузере. В таком случае вы увидите кнопку **Edit** (Изменить), как показано ниже. При нажатии **Edit** (или ее локализованного варианта) откроется исходный файл на GitHub. Если кнопка **Изменить** не отображается, значит страницу документа нельзя редактировать.
