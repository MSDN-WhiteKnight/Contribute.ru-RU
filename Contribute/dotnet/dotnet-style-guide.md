...
Лучший способ включить код — включить фрагменты кода из рабочего примера. Создайте свой пример кода в соответствии с инструкциями из статьи [об участии в составлении документации по .NET](dotnet-contribute.md#contribute-to-samples). Основные правила по включению кода вы найдете в общих рекомендациях по [коду](../code-in-docs.md).
...
* `-<language>` (*необязательно*, но *рекомендуется*)
  * Язык фрагмента кода, на который мы ссылаемся.

* `<name>` (*необязательно*)
  * Имя фрагмента кода. Оно не влияет на выходной код HTML, но его можно использовать для улучшения читаемости исходного кода Markdown.
